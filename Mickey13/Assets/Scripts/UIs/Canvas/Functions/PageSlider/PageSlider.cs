...
namespace TS.PageSlider
{
    ...
    public class PageSlider : MonoBehaviour
    {
        ...
        /// <summary>
        /// Called by the PageScroller component when a page change ends. Sets the page at the fromIndex to inactive and the page at the toIndex to active. Updates the PageDotsIndicator and invokes the OnBannerChanged event.
        /// </summary>
        /// <param name="fromIndex">The index of the page that is being deactivated.</param>
        /// <param name="toIndex">The index of the page that is being activated.</param>
